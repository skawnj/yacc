...
def func(request, call_string = None, option = None):
    ...
    if call_string != None:
        ...
        exec('res = yacc.yacc.' + call_string, globals())
        print(res)
...
def func_readable(request, call_string = None):
    return func(request, call_string, 'readable')
